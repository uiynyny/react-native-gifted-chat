    ...
    renderAvatar() {
        ...
        if (user) {
            if (typeof user.avatar === 'function') {
                ...
                return (<Image source={{ uri: user.avatar }} blurRadius={blur} style={[styles.avatarStyle, this.props.avatarStyle]}/>);
            }
            else if (typeof user.avatar === 'number') {
                return (<Image source={user.avatar} blurRadius={blur} style={[styles.avatarStyle, this.props.avatarStyle]}/>);
            }
        }
        return null;
    }
